...
export function Sidebar() {
  ...
  // Navigation structure based on user role and product track
  const navigation: NavigationSection[] = [
    ...
    },
    {
      ...
      items: [
        ...
        { name: 'Templates', href: '/inspection-templates', icon: FileText }
      ]
    },
    {
      title: 'Estimates & Work',
      items: [
        { name: 'Estimates', href: '/estimates', icon: DollarSign },
        { name: 'Work Orders', href: '/work-orders', icon: Wrench },
        { name: 'Price Books', href: '/price-books', icon: FileText }
      ]
    },
    {
      ...
      items: [
        ...
        { name: 'Advanced Scheduling', href: '/scheduling', icon: CalendarClock }
      ]
    },
    {
      title: 'Operations',
    ...
    },
    {
      title: 'Business',
      items: [
        { name: 'Service Plans', href: '/service-plans', icon: DollarSign }
      ]
    },
    {
      title: 'Settings',
      ...
      <div className="flex items-center justify-between p-4 border-b border-gray-200">
        {!isCollapsed && (
          <div className="flex items-center space-x-2">
            ...
            <span className="font-semibold text-gray-900">Irrigation Pro</span>
          </div>
        )}
        <button
